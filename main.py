...
def main():
    ...
    # Запуск веб-сервера у окремому процесі
    web_manager_path = os.path.join(os.path.dirname(__file__), 'web_manager', 'run_server.py')
    subprocess.Popen(['python', web_manager_path], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
