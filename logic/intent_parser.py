...
class IntentParser:
    def __init__(self):
        self.COMMAND_RULES = [
            ...
            {"roots": [["налашт"], ["відкр", "настр"], ["відкр", "сеттинг"], ["налаштуван"], ["настр"], ["сеттинг"]], "action": web_search.open_settings},
            
            # Плейлисти
            {"roots": [["ранд", "плей"], ["випадк", "плейл"]], "action": media_control.play_custom_playlist, "playlist_key": "random"},
            {"roots": [["Назва_плейлиста"]], "action": media_control.play_custom_playlist, "playlist_key": "Назва_плейлиста з конфіга"},#Додайте конкретні правила для кожного плейлиста, якщо потрібно
